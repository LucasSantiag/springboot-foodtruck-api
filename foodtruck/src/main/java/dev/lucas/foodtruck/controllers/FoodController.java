...
public class FoodController {
    ...
    @Autowired
    public FoodController(FoodServiceImplementation serviceImplementation) {
    ...
    public ResponseEntity postFood(@ApiParam(name = "food", value = "food") @RequestBody Food food) {
        logger.info("Starting lunch creation");
        food = serviceImplementation.save(food);
        logger.info("Created");
    ...
    public void updateFood(@ApiParam(name = "id", value = "long") @PathVariable Long id,
                               @ApiParam(name = "food", value = "food") @RequestBody Food food) {
